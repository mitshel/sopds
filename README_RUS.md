...
2.2 Далее в конфигурационном файде sopds/settings.py нужно закомментировать строки подключения к БД sqlite и соответсвенно раскомментировать
...
3.2 Далее в конфигурационном файде sopds/settings.py нужно закомментировать строки подключения к БД sqlite и соответсвенно раскомментировать
