...
parser=OptionParser(conflict_handler="resolve", version="sopds-scan.py. Version 0.10.1", add_help_option=True, usage='sopds-scan.py [options]', description='sopds-scan.py: Simple OPDS Scanner - programm for scan your e-books directory and store data to MYSQL database.')
