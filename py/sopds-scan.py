...
if (__name__=="__main__"):
    parser=OptionParser(conflict_handler="resolve", version="sopds-opdsdb.py. Version "+sopdscfg.VERSION, add_help_option=True, usage='sopds-opdsdb.py [options]',description='sopds-opdsdb.py: Simple OPDS Scanner - programm for scan your e-books directory and store data to MYSQL database.')
